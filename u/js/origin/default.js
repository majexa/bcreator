...
Locale.define('en-US', 'Core', {"keepEmptyIfNotChanges":"Keep empty if you don't wish to change your password","add":"Add","clean":"Clean","delete":"Delete","uploading":"Uploading","uploadComplete":"Upload complete","change":"Change","areYouSure":"Are you sure?"});
...
/*--|/home/user/ngn-env/ngn/i/js/ngn/Ngn.ResizableTextarea.js|--*/
Ngn.ResizableTextarea = new Class({
  ...
  getHandler: function(el) {
    if (this.options.handler) return this.options.handler;
    if (!el.handler) {
  ...
  injectHandler: function(el) {
    return el.handler.inject(el.eResizable, 'after');
  }
