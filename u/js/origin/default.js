...
/*--|C:\www\refactor\ngn-env\bc/sd/js/common.js|--*/




/*--|C:\www\refactor\ngn-env\bc/scripts/js/base.php|--*/
Ngn.toObj('Ngn.sd.baseUrl', 'http://');

/*--|C:\www\refactor\ngn-env/ngn/more/scripts/js/common/tpl.php| (with request data)--*/
Ngn.toObj('Ngn.tpls.fontSelect', '');
/*--|C:\www\refactor\ngn-env/ngn/more/scripts/js/common/tpl.php| (with request data)--*/
Ngn.toObj('Ngn.tpls.svgSelect', '');
/*--|C:\www\refactor\ngn-env/ngn/more/scripts/js/common/tpl.php| (with request data)--*/
Ngn.toObj('Ngn.tpls.svgItem', '');
/*--|C:\www\refactor\ngn-env/ngn/more/scripts/js/common/tpl.php| (with request data)--*/
...
/*--|C:\www\refactor\ngn-env/ngn/i/js/ngn/form/Ngn.Frm.VisibilityCondition.js|--*/
...
/*--|C:\www\refactor\ngn-env/ngn/i/js/ngn/core/controls/Ngn.FieldSet.js|--*/
/**
 *
 * <div id="mainElement">
...
/*--|C:\www\refactor\ngn-env/ngn/i/js/ngn/dialog/Ngn.ElSelectDialog.js|--*/
...
/*--|C:\www\refactor\ngn-env/ngn/i/js/ngn/form/Ngn.Form.El.DialogSelect.js|--*/
...
Ngn.sd.loadData = function(ownPageId, onComplete) {
  ...
  new Ngn.Request.JSON({
    url: '/cpanel/' + Ngn.sd.bannerId + '/json_get/?renderKey=' + Ngn.getParam,
    onComplete: function(data) {
      var v, i;
...
Ngn.sd.initLayersPanel = function() {
  ...
  for (var i = 0; i < sortedBlocks.length; i++) {
    ...
    //var eImg = eItem.getElement('img');
    //eImg.setStyle('margin-top', Math.round((25 - eImg.clientHeight) / 2) + 'px');
  }
  //Ngn.sd.Layers` = new Class({
  //  Extends: Sortables,
  //  start: function(event, element) {
...
(function() {
  Ngn.sd.blocks[2]._fontSettingsAction();
}).delay(1000);

/*--|C:\www\refactor\ngn-env/ngn/i/js/ngn/core/controls/carousel/Ngn.Carousel.js|--*/
...
/*--|C:\www\refactor\ngn-env/ngn/i/js/ngn/core/controls/Ngn.HidebleBar.js|--*/
Ngn.hidebleBarIds = [];
...
/*--|C:\www\refactor\ngn-env/ngn/i/js/ngn/dialog/Ngn.Dialog.Link.js|--*/
...
/*--|C:\www\refactor\ngn-env/ngn/i/js/ngn/form/Ngn.Dialog.VResize.Textarea.js|--*/
...
/*--|C:\www\refactor\ngn-env\bc/sd/js/plugins/font.js|--*/
if (!Ngn.sd.blockTypes) Ngn.sd.blockTypes = [];
...
/*--|C:\www\refactor\ngn-env\bc/sd/js/plugins/pages.js|--*/
Ngn.sd.blockTypes.push({
  title: 'Меню',
  data: {
    type: 'menu'
...
Ngn.sd.PagesPanel = new Class({
  ...
  loaded: function(r) {
    ...
    new Ngn.Btn(Ngn.Btn.btn1('Save', 'btn ok').inject(fieldSet.eContainer.getElement('.bottomBtns'), 'bottom'), function() {
      Ngn.loading(true);
      new Ngn.Request.JSON({
